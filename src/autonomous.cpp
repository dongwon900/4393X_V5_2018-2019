...
<<<<<<< HEAD
  ...
  auto myChassis = ChassisControllerFactory::create(
    ...
    {robotAuto.drivetrain.driveRightF, robotAuto.drivetrain.driveRightB},   // Right motors
 ...
 robotAuto.drivetrain.driveAll(8000, 8000);
 pros::Task::delay(500);
 robotAuto.drivetrain.driveAll(0, 0);
 forkController.setTarget(robotAuto.forklift.forkMotor.getPosition() - 2200);
...
=======
 ...
 // robotAuto.drivetrain.driveAll(-12000, 12000);
 // pros::Task::delay(2500);
>>>>>>> 85d444177fb7bf516f9cc7335ef6abf9263dec80
}
